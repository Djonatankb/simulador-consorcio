...
- OTP: limite de **5 tentativas de verificação** por código (anti-brute-force) + limite de 3 envios/10 min; código derivado de UUID. O widget exibe contador regressivo de 60s e então libera o reenvio (correção de número sempre disponível), dentro do mesmo limite de envios.
